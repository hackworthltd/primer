...
forBody tydefs l Editable expr id = sortByPriority l $ case findNodeWithParent id expr of
  ...
  Just (KindNode k, _) -> [] -- TODO: replace this with @forKind l k@ when we support running actions in this position
...
forSig l Editable ty id = sortByPriority l $ case findTypeOrKind id ty of
  ...
  Just (Right k) -> [] -- TODO: replace this with @forKind l k@ when we support running actions in this position
