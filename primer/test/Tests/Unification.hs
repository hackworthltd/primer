...
-- arbitrary context and arbitrary unif vars (in arbitrary order, rather than
-- just having unif vars at the end). See
-- https://github.com/hackworthltd/vonnegut/pull/800
