...
unit_typeDefKind = do
  algTypeDefKind boolDef @?= KType
  algTypeDefKind natDef @?= KType
  algTypeDefKind listDef @?= KFun KType KType
  algTypeDefKind eitherDef @?= KFun KType (KFun KType KType)
