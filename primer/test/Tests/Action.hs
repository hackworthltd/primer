...
unit_refine_mismatch =
  actionTest
    ...
    (hole (conSat cCons [tEmptyHole] [emptyHole, emptyHole]) `ann` tcon tNat)
...
unit_refine_arr_1 =
  actionTest
    ...
    [Move Child1, constructRefinedCon cCons]
    (hole (conSat cCons [tEmptyHole] [emptyHole, emptyHole]) `ann` (tEmptyHole `tfun` tEmptyHole))
...
unit_refine_arr_2 =
  actionTest
    ...
    [Move Child1, constructRefinedCon cCons]
    (hole (conSat cCons [tEmptyHole] [emptyHole, emptyHole]) `ann` ((tcon tList `tapp` tcon tNat) `tfun` (tcon tList `tapp` tcon tNat)))
...
unit_move_ctor = actionTest NoSmartHoles
  emptyHole
  [constructSaturatedCon cMakePair
  ,EnterConTypeArgument 0, constructTCon tNat, ExitType
  ,EnterConTypeArgument 1, constructTCon tBool, ExitType
  ,Move $ ConChild 0, constructSaturatedCon cZero, Move Parent
  ,Move $ ConChild 1, constructSaturatedCon cFalse, Move Parent
  ]
